...
GIT_REPO_NAME = "LETHAL-USERBOT"
UPSTREAM_REPO_URL = "https://github.com/Javes786/LETHAL-USERBOT"
...
@Lethal.on(admin_cmd(pattern="update ?(.*)"))
async def upstream(ups):
    ...
    if ac_br != "main":
        await ups.edit(
            ...
            "Please checkout the official branch of Lethal"
        )
        repo.__del__()
        return
