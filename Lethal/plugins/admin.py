...
from Lethal import BOTLOG, BOTLOG_CHATID, CMD_HELP
from Lethal.LethalConfig import Var
from Lethal.utils import admin_cmd, errors_handler, sudo_cmd
...
@Lethal.on(admin_cmd(outgoing=True, pattern="setgpic"))
@Lethal.on(sudo_cmd(outgoing=True, pattern="setgpic", allow_sudo=True))
@errors_handler
...
@Lethal.on(admin_cmd("promote(?: |$)(.*)"))
@Lethal.on(sudo_cmd(pattern="promote(?: |$)(.*)", allow_sudo=True))
@errors_handler
...
@Lethal.on(admin_cmd(outgoing=True, pattern="demote(?: |$)(.*)"))
@Lethal.on(sudo_cmd(pattern="demote(?: |$)(.*)", allow_sudo=True))
@errors_handler
...
@Lethal.on(admin_cmd(pattern="(ban|unban) ?(.*)"))
@Lethal.on(sudo_cmd(pattern="(ban|unban) ?(.*)", allow_sudo=True))
async def _(event):
...
@Lethal.on(admin_cmd(pattern="pgs ?(.*)"))
@Lethal.on(sudo_cmd(pattern="pgs ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Lethal.on(admin_cmd(outgoing=True, pattern="admins$"))
@errors_handler
...
@Lethal.on(admin_cmd(outgoing=True, pattern="pin(?: |$)(.*)"))
@Lethal.on(sudo_cmd(outgoing=True, pattern="pin(?: |$)(.*)"))
@errors_handler
async def pin(msg):
...
@Lethal.on(admin_cmd(outgoing=True, pattern="kick(?: |$)(.*)"))
@Lethal.on(sudo_cmd(outgoing=True, pattern="kick(?: |$)(.*)", allow_sudo=True))
@errors_handler
async def kick(usr):
...
@Lethal.on(admin_cmd(outgoing=True, pattern="users ?(.*)"))
@errors_handler
