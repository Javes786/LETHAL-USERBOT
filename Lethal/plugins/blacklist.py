...
import Lethal.plugins.sql_helper.blacklist_sql as sql
...
@Lethal.on(admin_cmd(pattern="addblacklist ((.|\n)*)"))
@Lethal.on(sudo_cmd(pattern="addblacklist ((.|\n)*)"))
...
@Lethal.on(admin_cmd(pattern="listblacklist"))
@Lethal.on(sudo_cmd(pattern="listblacklist"))
...
@Lethal.on(admin_cmd(pattern="rmblacklist ((.|\n)*)"))
@Lethal.on(sudo_cmd(pattern="rmblacklist ((.|\n)*)"))
