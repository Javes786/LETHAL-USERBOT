...
from Lethal import CMD_HELP, bot
from Lethal.utils import admin_cmd
...
@Lethal.on(admin_cmd(outgoing=True, pattern="spd(?: |$)(.*)"))
@Lethal.on(sudo_cmd(allow_sudo=True, pattern="spd(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
    ...
    async with bot.conversation(chat) as conv:
        ...
        await msg.edit(
            f"Song name - __{link}__\nUploaded by [Lethal](https://t.me/LethalSupport)"
        )


@Lethal.on(admin_cmd(outgoing=True, pattern="netease(?: |$)(.*)"))
@Lethal.on(sudo_cmd(allow_sudo=True, pattern="netease(?: |$)(.*)"))
...
@Lethal.on(admin_cmd(outgoing=True, pattern="dzd(?: |$)(.*)"))
@Lethal.on(sudo_cmd(allow_sudo=True, pattern="dzd(?: |$)(.*)"))
