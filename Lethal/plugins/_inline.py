...
fuk_uid = bot.uid
HELP_PIC = "https://telegra.ph/file/c369f5af168e62255d27e.jpg"
PMPERMIT_PIC = os.environ.get("PMPERMIT_PIC", None)
TELEPIC = (
    PMPERMIT_PIC
    if PMPERMIT_PIC
    else "https://telegra.ph/file/c369f5af168e62255d27e.jpg"
)
PM_WARNS = {}
PREV_REPLY_MESSAGE = {}
myid = bot.uid
...
MESAG = (
    str(CUSTOM_PMPERMIT)
    if CUSTOM_PMPERMIT
    else "`𝚈𝙾𝙾 𝙷𝙴𝚁𝙴 𝙸𝚂 𝙻𝙴𝚃𝙷𝙰𝙻 𝙿𝙼 𝚂𝙴𝙲𝚄𝚁𝙸𝚃𝚈! 𝙿𝙻𝙴𝙰𝚂𝙴 𝚆𝙰𝙸𝚃 𝚃𝙸𝙻𝙻 𝙼𝚈 𝙼𝙰𝚂𝚃𝙴𝚁 𝙰𝙿𝙿𝚁𝙾𝚅𝙴. 🤓"
)
...
if Var.LOAD_MYBOT == "True":
    USER_BOT_NO_WARN = (
        "**𝙷𝙴𝚈 𝚃𝙷𝙸𝚂 𝙸𝚂 𝙻𝙴𝚃𝙷𝙰𝙻 𝙿𝙼 𝚂𝙴𝙲𝚄𝚁𝙸𝚃𝚈 !!! 𝙷𝙴𝚁𝙴 𝚃𝙾 𝙿𝚁𝙾𝚃𝙴𝙲𝚃 [{}](tg://user?id={})**\n\n"
        "{}\n\n"
...
if Var.TG_BOT_USER_NAME_BF_HER is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        result = None
        query = event.text
        if event.query.user_id == bot.uid and query.startswith("ℓєτнαℓ"):
            rev_text = query[::-1]
            ...
            but += [[Button.url("🔰 Sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ »»", "t.me/DestroyXSupport"), Button.url("🔰 Uᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ", "t.me/DesTRoyXOfficial")]]
            ...
            result = builder.article(
                ...
                buttons=[
                    ...
                    [Button.url("Repo", "https://github.com/Javes786/LETHAL-USERBOT")],
                    [
                        Button.url(
                            "𝙳𝙴𝙿𝙻𝙾𝚈 𝙽𝙾𝚆!",
                            "https://heroku.com/deploy?template=https://github.com/Javes786/LETHAL-USERBOT",
                        )
                    ],
                ],
            )
            ...
            result = builder.article(
                title="Repository",
                text=f"Lethal - Telegram Userbot.",
                buttons=[
                    [
                        Button.url("𝙻𝙴𝚃𝙷𝙰𝙻 𝚁𝙴𝙿𝙾", "https://github.com/Javes786/LETHAL-USERBOT"),
                        Button.url(
                            "𝙳𝙴𝙿𝙻𝙾𝚈 𝙽𝙾𝚆",
                            "https://heroku.com/deploy?template=https://github.com/Javes786/LETHAL-USERBOT",
                        ),
        ...
        try:
            result = builder.article(
                ...
                buttons=[
                    ...
                    [
                        custom.Button.url(
                            "👨‍💻Source Code‍💻", "https://github.com/Javes786/LETHAL-USERBOT"
                        ),
                        custom.Button.url(
                            "Deploy 🌀",
                            "https://heroku.com/deploy?template=https://github.com/Javes786/LETHAL-USERBOT",
                    ...
                    [custom.Button.url("Updates ↗️", "https://t.me/Destroyxsupport")],
                ],
                link_preview=False,
            )
    ...
    async def on_plug_in_callback_query_handler(event):
        if event.query.user_id == bot.uid:  # pylint:disable=E0602
            ...
            reply_pop_up_alert = (
                "Please get your own Userbot from @Destroyxsupport , and don't use mine!"
            )
...
async def _(event):
    ...
    async def on_plug_in_callback_query_handler(event):
        if event.query.user_id == bot.uid:
            ...
            reply_pop_up_alert = "Please get your own userbot from @DestroyXSupport "
            await event.answer(reply_pop_up_alert, cache_time=0, alert=True)
