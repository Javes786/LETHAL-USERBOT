...
from Lethal.plugins.sql_helper.mute_sql import is_muted, mute, unmute
from Lethal.utils import admin_cmd


@Lethal.on(admin_cmd(outgoing=True, pattern=r"mute ?(\d+)?"))
@Lethal.on(sudo_cmd(allow_sudo=True, pattern=r"mute ?(\d+)?"))
...
@Lethal.on(admin_cmd(outgoing=True, pattern=r"unmute ?(\d+)?"))
@Lethal.on(sudo_cmd(allow_sudo=True, pattern=r"unmute ?(\d+)?"))
...
@Lethal.on(admin_cmd(incoming=True))
