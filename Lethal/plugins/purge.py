...
from Lethal.utils import admin_cmd, errors_handler

BOTLOG_CHATID = Var.PRIVATE_GROUP_ID


@Lethal.on(admin_cmd(outgoing=True, pattern="purge"))
@Lethal.on(sudo_cmd(allow_sudo=True, pattern="purge"))
@errors_handler
...
@Lethal.on(admin_cmd(outgoing=True, pattern="purgeme"))
@errors_handler
...
@Lethal.on(admin_cmd(outgoing=True, pattern="del"))
@errors_handler
...
@Lethal.on(admin_cmd(outgoing=True, pattern="edit"))
@errors_handler
...
@Lethal.on(admin_cmd(outgoing=True, pattern="sd"))
@errors_handler
