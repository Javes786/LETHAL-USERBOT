...
@Lethal.on(admin_cmd(outgoing=True, pattern=r"gmute ?(\d+)?"))
@Lethal.on(sudo_cmd(allow_sudo=True, pattern=r"gmute ?(\d+)?"))
...
@Lethal.on(admin_cmd(outgoing=True, pattern=r"ungmute ?(\d+)?"))
@Lethal.on(sudo_cmd(allow_sudo=True, pattern=r"ungmute ?(\d+)?"))
