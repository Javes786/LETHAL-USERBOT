...
from Lethal.LethalConfig import Config
...
@Lethal.on(admin_cmd(pattern="tspam"))
@Lethal.on(sudo_cmd(pattern="tspam", allow_sudo=True))
async def tmeme(e):
    tspam = str(e.text[7:])
...
@Lethal.on(admin_cmd(pattern="spam"))
@Lethal.on(sudo_cmd(pattern="spam", allow_sudo=True))
async def spammer(e):
...
@Lethal.on(admin_cmd(pattern="bigspam"))
@Lethal.on(sudo_cmd(pattern="bigspam", allow_sudo=True))
async def bigspam(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        message = e.text
...
@Lethal.on(admin_cmd(pattern="picspam"))
@Lethal.on(sudo_cmd(pattern="picspam", allow_sudo=True))
...
@Lethal.on(admin_cmd("delayspam (.*)"))
@Lethal.on(sudo_cmd(pattern="delayspam (.*)", allow_sudo=True))
...
@Lethal.on(admin_cmd(pattern="spspam$"))
@Lethal.on(sudo_cmd(pattern="spspam$", allow_sudo=True))
...
@Lethal.on(admin_cmd("cspam (.*)"))
@Lethal.on(sudo_cmd(pattern="cspam (.*)", allow_sudo=True))
...
@Lethal.on(admin_cmd("wspam (.*)"))
@Lethal.on(sudo_cmd(pattern="wspam (.*)", allow_sudo=True))
async def tmeme(event):
...
@Lethal.on(admin_cmd(pattern="raid (.*)"))
@Lethal.on(sudo_cmd(pattern="raid (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if event.reply_to_msg_id:
