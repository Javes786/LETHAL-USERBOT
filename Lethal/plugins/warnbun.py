...
@Lethal.on(admin_cmd(pattern="warn1"))
@Lethal.on(sudo_cmd(pattern="warn1", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mentions = (
...
@Lethal.on(admin_cmd(pattern="warn2"))
@Lethal.on(sudo_cmd(pattern="warn2", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Lethal.on(admin_cmd(pattern="warn3"))
@Lethal.on(admin_cmd(pattern="warn3", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mentions = (
...
@Lethal.on(admin_cmd(pattern="warn0"))
@Lethal.on(admin_cmd(pattern="warn0", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Lethal.on(admin_cmd(pattern="ocb"))
@Lethal.on(sudo_cmd(pattern="ocb", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Lethal.on(admin_cmd(pattern="fw"))
async def _(event):
    if event.fwd_from:
        return
