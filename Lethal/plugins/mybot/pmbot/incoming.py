...
from Lethal.plugins.mybot.sql.users_sql import add_user_to_db
from Lethal.plugins.mybot.sql.blacklist_sql import check_is_black_list
from telethon import events
from Lethal.plugins import OWNER_ID
