...
async def hmm(yes):
    ...
    pm_caption += f"{lethalemoji} **𝙇𝙀𝙏𝙃𝘼𝙇 𝙑𝙀𝙍𝙎𝙄𝙊𝙉**: `{lethalver}`\n"
    pm_caption += f"{lethalemoji} **𝙏𝙀𝙇𝙀𝙏𝙃𝙊𝙉 𝙑𝙀𝙍𝙎𝙄𝙊𝙉** ☞ {version.__version__}\n"
    pm_caption += f"{lethalemoji} **𝙎𝙐𝙋𝙋𝙊𝙍𝙏 𝘾𝙃𝘼𝙉𝙉𝙀𝙇** ☞ [ᴊᴏɪɴ](https://t.me/DESTROYXOFFICIAL)\n"
    pm_caption += f"{lethalemoji} **𝙇𝙀𝙏𝙃𝘼𝙇 𝙐𝙋𝙏𝙄𝙈𝙀** ☞ {uptime}\n\n"
