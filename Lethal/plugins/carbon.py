...
from Lethal import CHROME_DRIVER, CMD_HELP, GOOGLE_CHROME_BIN
...
@Lethal.on(admin_cmd(pattern="carbon"))
@Lethal.on(sudo_cmd(pattern="carbon", allow_sudo=True))
