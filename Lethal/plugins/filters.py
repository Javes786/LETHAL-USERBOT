...
from Lethal.plugins.sql_helper.filter_sql import (
    add_filter,
    get_all_filters,
    remove_all_filters,
    remove_filter,
...
@Lethal.on(admin_cmd(pattern="savefilter (.*)"))
@Lethal.on(sudo_cmd(pattern="savefilter (.*)", allow_sudo=True))
...
@Lethal.on(admin_cmd(pattern="listfilters"))
@Lethal.on(sudo_cmd(pattern="listfilters", allow_sudo=True))
...
@Lethal.on(admin_cmd(pattern="clearfilter (.*)"))
@Lethal.on(sudo_cmd(pattern="clearfilter (.*)", allow_sudo=True))
...
@Lethal.on(admin_cmd(pattern="clearallfilters"))
@Lethal.on(sudo_cmd(pattern="clearallfilters", allow_sudo=True))
