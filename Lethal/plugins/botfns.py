...
telegraph = Telegraph()
mee = telegraph.create_account(short_name="Lethal")


@Lethal.on(admin_cmd(pattern="purl ?(.*)"))
@Lethal.on(sudo_cmd(pattern="purl ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Lethal.on(admin_cmd(pattern="reader ?(.*)"))
@Lethal.on(sudo_cmd(pattern="reader ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
...
@Lethal.on(admin_cmd(pattern="aud ?(.*)"))
@Lethal.on(sudo_cmd(pattern="aud ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
...
@Lethal.on(admin_cmd(pattern="instadl ?(.*)"))
@Lethal.on(sudo_cmd(pattern="instadl ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
...
@Lethal.on(admin_cmd(pattern="stat$"))
@Lethal.on(sudo_cmd(pattern="stat$", allow_sudo=True))
...
@Lethal.on(admin_cmd(pattern="xogame$"))
@Lethal.on(sudo_cmd(pattern="xogame$", allow_sudo=True))
...
@Lethal.on(admin_cmd(pattern="wspr ?(.*)"))
@Lethal.on(sudo_cmd(pattern="wspr ?(.*)", allow_sudo=True))
...
@Lethal.on(admin_cmd(pattern="crack ?(.*)"))
@Lethal.on(sudo_cmd(pattern="crack ?(.*)", allow_sudo=True))
async def mod(event):
    if event.fwd_from:
        return
...
@Lethal.on(admin_cmd(pattern="checkspam ?(.*)"))
@Lethal.on(sudo_cmd(pattern="checkspam ?(.*), allow_sudo=True"))
async def _(event):
    bot = "@SpamBot"
    if event.fwd_from:
        return
...
@Lethal.on(admin_cmd(pattern="gitdl ?(.*)"))
@Lethal.on(sudo_cmd(pattern="gitdl ?(.*), allow_sudo=True"))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
    ...
    async with event.client.conversation(chat) as conv:
        ...
        await x.edit("Downloaded by [Lethal](t.me/LethalSupport), via @gitdownloadbot")


@Lethal.on(admin_cmd(pattern="imusic ?(.*)"))
@Lethal.on(sudo_cmd(pattern="imusic ?(.*)", allow_sudo=True))
async def tel(event):
    if event.fwd_from:
        return
...
@Lethal.on(admin_cmd(pattern="font ?(.*)"))
@Lethal.on(sudo_cmd(pattern="font ?(.*)", allow_sudo=True))
async def _(event):
    bot = "@fontsgenbot"
    if event.fwd_from:
        return
