...
@Lethal.on(admin_cmd(outgoing=True, pattern=r"save(?: |$)([\s\S]*)"))
@Lethal.on(sudo_cmd(allow_sudo=True, pattern=r"save(?: |$)([\s\S]*)"))
...
@Lethal.on(events.NewMessage(incoming=True, func=lambda e: e.is_private))
