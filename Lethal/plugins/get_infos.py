...
@Lethal.on(admin_cmd(pattern="get_ad?(m)in ?(.*)"))
@Lethal.on(sudo_cmd(pattern="get_ad?(m)in ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Lethal.on(admin_cmd(pattern="get_id"))
@Lethal.on(sudo_cmd(pattern="get_id", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if event.reply_to_msg_id:
...
@Lethal.on(admin_cmd(pattern="get_bot ?(.*)"))
@Lethal.on(sudo_cmd(pattern="get_bot ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
