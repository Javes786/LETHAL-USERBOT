...
from Lethal.plugins.sql_helper.ghdb_sql import (
    add_channel,
    get_all_channels,
    in_channels,
    rm_channel,
...
@Lethal.on(admin_cmd(pattern="forward ?(.*)"))
@Lethal.on(sudo_cmd(pattern="forward ?(.*)", allow_sudo=True))
...
@Lethal.on(admin_cmd(pattern="broadcast ?(.*)"))
@Lethal.on(sudo_cmd(pattern="broadcast ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mssg = await eor(event, "`...`")
...
@Lethal.on(admin_cmd(pattern="add ?(.*)"))
...
@Lethal.on(admin_cmd(pattern="rm ?(.*)"))
...
@Lethal.on(admin_cmd(pattern="listchannels"))
@Lethal.on(sudo_cmd(pattern="listchannels", allow_sudo=True))
...
@Lethal.on(admin_cmd(pattern="search ?(.*)"))
@Lethal.on(sudo_cmd(pattern="search ?(.*)", allow_sudo=True))
