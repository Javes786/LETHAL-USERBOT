...
@Lethal.on(admin_cmd(outgoing=True, pattern="lyrics ?(.*)"))
@Lethal.on(sudo_cmd(allow_sudo=True, pattern="lyrics ?(.*)"))
async def _(event):
...
@Lethal.on(admin_cmd(outgoing=True, pattern="glyrics ?(.*)"))
@Lethal.on(sudo_cmd(outgoing=True, pattern="glyrics ?(.*)", allow_sudo=True))
