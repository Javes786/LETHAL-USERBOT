...
@Lethal.on(admin_cmd(pattern="getqr"))
@Lethal.on(sudo_cmd(pattern="getqr", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    start = datetime.now()
...
@Lethal.on(admin_cmd(pattern="makeqr ?(.*)"))
@Lethal.on(sudo_cmd(pattern="makeqr ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    start = datetime.now()
